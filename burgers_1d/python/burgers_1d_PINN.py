...
class PINN(nn.Module):
    def __init__(self, Layers, N0, Nb, Nf, initial_weight, boundary_weight, lb_X, ub_X):
        ...
        self.params = []
        # Initialize the parameters of fully connected neural network 
...
if __name__ == "__main__":
    ...
    for seed in seeds: 
        ...
        Layers = [2,512,512,512,512,512,1] # fully connected neural network structure
        learning_rate = 0.005 
        ...
        if train:
            ...
            model = PINN(Layers, N0, Nb, Nf, initial_weight, boundary_weight, lb_X, ub_X)
